...
<div class="main-content">
    ...
    <div class="content">
        ...
        <a href="./EditBooking" target="_blank">clicking here</a> and supplying your booking number and email.<br>
    ...
    <div class="content">
        <fieldset>
            ...
            Your booking update has been received and reserved. <br>
            <h2>Order details:</h2>
            ...
            The following rooms are now reserved for you: 
            <ul>
                <% if(nStdT > 0) { %>
