        ...
        <fieldset class="content-bg">
            ...
            <div class="form-card-container" id="room_messages">
                <div class="form-card">
                    ...
                    <input id="std_d" class="form-spacing" type="number" name="std_d" min="0" value="<% out.print(roomsReq.get("std_d")); %>" onchange="hide_payment()">
                ...
                <div class="form-card">
                    ...
                    <input id="std_t" class="form-spacing" type="number" name="std_t" min="0" value="<% out.print(roomsReq.get("std_t")); %>" onchange="hide_payment()">
                    <%-- This section should only be displayed if a query was submitted --%>
                    <% if (showQuant) { %>
                    <div>
                        <div class="form-spacing-small">Available</div>
                ...
                <div class="form-card">
                    ...
                    <input id="sup_d" class="form-spacing" type="number" name="sup_d" min="0" value="<% out.print(roomsReq.get("sup_d")); %>" onchange="hide_payment()">
                    <%-- This section should only be displayed if a query was submitted --%>
                    <% if (showQuant) { %>
                    <div>
                        <div class="form-spacing-small">Available</div>
                ...
                <div class="form-card">
                    ...
                    <input id="sup_t" class="form-spacing" type="number" name="sup_t" min="0" value="<% out.print(roomsReq.get("sup_t")); %>" onchange="hide_payment()">
                    <%-- This section should only be displayed if a query was submitted --%>
                    <% if (showQuant) { %>
                    <div>
                        <div class="form-spacing-small">Available</div>
                ...
                <div class="form-card">
                    ...
                    <input class="form-spacing" type="date" name="checkin" value="<% out.print(b.getRooms().get(0).getCheckin()); %>" id="rooms_check_in" onchange="sanity_dates(this); hide_payment()" required>
                    <div class="form-spacing-small">Check-out Date</div>
                    <input class="form-spacing" type="date" name="checkout" value="<% out.print(b.getRooms().get(0).getCheckout()); %>" id="rooms_check_out" onchange="sanity_dates(this); hide_payment()" required>
